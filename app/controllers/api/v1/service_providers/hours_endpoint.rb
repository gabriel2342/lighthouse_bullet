class Api::V1::ServiceProviders::HoursEndpoint < Api::V1::Root
  helpers do
  ...
  resource "municipalities", desc: Api.title(:collection_actions) do
    after_validation do
      load_and_authorize_api_resource ServiceProviders::Hour
    end
    ...
    get "/:municipality_id/service_providers/hours" do
    ...
    oauth2 "write"
    post "/:municipality_id/service_providers/hours" do
      if @hour.save
  ...
  resource "service_providers/hours", desc: Api.title(:member_actions) do
    after_validation do
      load_and_authorize_api_resource ServiceProviders::Hour
    end
